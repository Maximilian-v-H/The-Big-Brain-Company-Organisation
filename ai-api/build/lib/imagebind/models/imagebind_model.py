...
def imagebind_huge(pretrained=False, docker=False):
    ...
    if pretrained:
        if docker:
            if not os.path.exists("/Semantic-api/app/.checkpoints/imagebind_huge.pth"):
                print(
            ...
            model.load_state_dict(torch.load("/Semantic-api/app/.checkpoints/imagebind_huge.pth"))
        else:
            if not os.path.exists("app/.checkpoints/imagebind_huge.pth"):
                print(
                    "Downloading imagebind weights to .checkpoints/imagebind_huge.pth ..."
                )
                os.makedirs(".checkpoints", exist_ok=True)
                torch.hub.download_url_to_file(
                    "https://dl.fbaipublicfiles.com/imagebind/imagebind_huge.pth",
                    "app/.checkpoints/imagebind_huge.pth",
                    progress=True,
                )
